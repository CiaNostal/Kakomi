...
export async function drawPreview(currentState, previewCanvas, previewCtx) { // async追加
    ...
    // 7. テキスト描画
    if (currentState.textSettings.date.enabled || currentState.textSettings.exif.enabled || currentState.textSettings.freeText.enabled || currentState.textSettings.freeText2.enabled) {
